        ...
        <div class="container max-w-screen-lg mx-auto">
          <div>
            ...
            <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                <form method="POST" action="{{ route('ListadoEquipo.update',$ListadoEquipo->id) }}"  role="form" enctype="multipart/form-data" id="validacion">
                    {{ method_field('PATCH') }}
                    @csrf
                    @include('Listado.ListadoEquipos.P1.formP1')
                </form>
            </div>
          </div>
        </div>
