                                    ...
                                    <dl class="divide-y divide-gray-100">
                                        ...
                                        <table class="w-full divide-y divide-gray-300">
                                            ...
                                            <tbody class="divide-y divide-gray-200 bg-white">
                                                ...
                                                @foreach ($ListadoPuntoP1 as $listadopunto)
                                                ...
                                                <tr class="even:bg-gray-50">
                                                    ...
                                                    <td class=" py-4 pl-4 pr-3 text-sm font-medium text-gray-900">
                                                        ...
                                                        <form action="{{ route('ListadoPunto.destroy', $listadopunto->id) }}" method="POST">
                                                            ...
                                                            <a href="{{ route('ListadoPunto.editP1', $listadopunto->id) }}" class="text-indigo-600 font-bold hover:text-indigo-900  mr-2">{{ __('Editar') }}</a>
                                                            @csrf
                                                            @method('DELETE')
