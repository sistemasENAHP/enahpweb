<div class="space-y-6">
    <div class="grid gap-3 gap-y-2 text-sm grid-cols-1 lg:grid-cols-2">
        ...
        <x-text-input type="hidden" id="piso_idP1" name="piso_idP1" :value="2,old('piso_id',$ListaIp?->piso_id)" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" autocomplete="P1" placeholder="P1"/>
