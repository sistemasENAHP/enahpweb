    ...
    <div class="md:col-span-2">
      ...
      <div class="md:col-span-2">
        ...
        <div class="md:col-span-2">
            ...
            <x-text-input type="text" name="Cedula" id="Cedula" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" autocomplete="Cedula" placeholder="Cedula" :value="old('Cedula',$ListaIp?->Cedula)" onKeypress='if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;'/>
