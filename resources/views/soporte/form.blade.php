          ...
          <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
            ...
            <div class="md:col-span-2">
              ...
              <div class="md:col-span-2">
                ...
                <x-text-input type="datetime"  name="FechaSalida" id="FechaSalida" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50"  value="{{$date,old('FechaSalida',$soporte?->FechaSalida)}}" placeholder="" readonly />
