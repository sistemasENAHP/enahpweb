<x-app-layout>
    ...
    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3" id="on">
        ...
        @else
           ...
           <strong class="text-red-500">!Error! No existe ningun Registro Vuelve a Intentar Nuevamente!</strong><a href="/Soportes/create" id="editar" name="editar" class="text-indigo-600 font-bold hover:text-indigo-900  mr-2">{{ __('Regresar') }}</a>
