...
<div class="grid gap-4 gap-y-3 text-sm grid-cols-1 md:grid-cols-5" style="margin-left:320px;">
            <div class="md:col-span-5 " style="margin-bottom: 0rem; ">
              ...
              <div class="md:col-span-5 " style="margin-bottom: 2rem;">
                <button type="button" class="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Buscar</button>
              </div>
            </form>
</div>
</div>
